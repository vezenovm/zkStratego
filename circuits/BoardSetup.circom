...
template BoardSetup() {
    ...
    for (var i = 0; i < 40; i++) {
        ...
        pieceInRangeValidatorP1[i].x <== playerPieces[i][0];
        pieceInRangeValidatorP1[i].y <== playerPieces[i][1];
    ...
    for (var i = 0; i < 40; i++) {
        for (var j = i+1; j < 40; j++) {
            ...
            collisionCheckerP1[k].in[0] <== playerPieces[i][0];
            collisionCheckerP1[k].in[1] <== playerPieces[j][0];

            collisionCheckerP1[k + 1] = IsEqual();
            collisionCheckerP1[k + 1].in[0] <== playerPieces[i][1];
            collisionCheckerP1[k + 1].in[1] <== playerPieces[j][1];
    ...
    //         collisionCheckerP2[k].in[0] <== playerPieces[i][0];
    //         collisionCheckerP2[k].in[1] <== playerPieces[j][0];
