...
void Move_4_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Move_4_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_main_input_signal_no() {return 249;}

uint get_total_signal_no() {return 214257;}

uint get_number_of_components() {return 563;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 159625;}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[1],&lvar[3],&circuitConstants[1]); // line circom 23
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 3];
// load src
Fr_sub(&expaux[0],&lvar[3],&circuitConstants[1]); // line circom 24
// end load src
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 249;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[161];
}
...
for (uint i = 0; i < 80; i++) {
std::string new_cmp_name = "collisionCheckerPlayer"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint aux_dimensions[1] = {80};
for (uint i = 0; i < 80; i++) {
std::string new_cmp_name = "collisionCheckerOpponent"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
IsEqual_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 6 ;
aux_cmp_num += 2;
...
Fr_lt(&expaux[0],&lvar[13],&circuitConstants[81]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
...
{
uint cmp_index_ref = ((1 * (Fr_toInt(&lvar[12]) + 1)) + 0);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
// end load src
...
Fr_mul(&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[12])) + 0)]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * (Fr_toInt(&lvar[12]) + 1)) + 0)]].signalStart + 0]); // line circom 40
...
PFrElement aux_dest = &lvar[12];
// load src
Fr_add(&expaux[0],&lvar[12],&circuitConstants[5]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[13];
// load src
Fr_add(&expaux[0],&lvar[13],&circuitConstants[1]); // line circom 31
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[13],&circuitConstants[81]); // line circom 31
...
Fr_lt(&expaux[0],&lvar[13],&circuitConstants[81]); // line circom 47
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((3 * Fr_toInt(&lvar[13])) + 0) + 121)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
IsEqual_1_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_mul(&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[12])) + 80)]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * (Fr_toInt(&lvar[12]) + 1)) + 80)]].signalStart + 0]); // line circom 56
...
PFrElement aux_dest = &lvar[12];
// load src
Fr_add(&expaux[0],&lvar[12],&circuitConstants[5]); // line circom 58
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[13];
// load src
Fr_add(&expaux[0],&lvar[13],&circuitConstants[1]); // line circom 47
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[13],&circuitConstants[81]); // line circom 47
...
Fr_lt(&expaux[0],&lvar[13],&circuitConstants[241]); // line circom 88
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[14];
// load src
Fr_idiv(&expaux[0],&lvar[13],&circuitConstants[7]); // line circom 89
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mod(&expaux[0],&lvar[13],&circuitConstants[7]); // line circom 90
// end load src
...
PFrElement aux_dest = &lvar[13];
// load src
Fr_add(&expaux[0],&lvar[13],&circuitConstants[1]); // line circom 88
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[13],&circuitConstants[241]); // line circom 88
...
Fr_lt(&expaux[0],&lvar[13],&circuitConstants[241]); // line circom 93
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[14];
// load src
Fr_idiv(&expaux[0],&lvar[13],&circuitConstants[7]); // line circom 94
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mod(&expaux[0],&lvar[13],&circuitConstants[7]); // line circom 95
// end load src
...
PFrElement aux_dest = &lvar[13];
// load src
Fr_add(&expaux[0],&lvar[13],&circuitConstants[1]); // line circom 93
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[13],&circuitConstants[241]); // line circom 93
}
Fr_eq(&expaux[0],&signalValues[mySignalStart + 249],&ctx->signalValues[ctx->componentMemory[mySubcomponents[160]].signalStart + 0]); // line circom 98
